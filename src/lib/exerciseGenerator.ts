...
const generatedTemplates: Exercise[] = [
  ...
  {
    id: 'generated-kettlebell-swing-primer',
    title: 'Generated Kettlebell Swing Primer',
    duration: 8,
    intensity: 'medium',
    equipment: ['Kettlebells'],
    instructions: ['Stand with feet just wider than hips', 'Hinge back and lightly guide the kettlebell between your legs', 'Drive through your feet to float the bell to chest height', 'Repeat 10 reps for 3 rounds'],
    tips: 'Focus on a crisp hip hinge and keep the bell close to your body path.',
    category: 'Strength',
    movementTags: ['hip_hinge'],
    bodyRegionTags: ['hips_glutes', 'core'],
    contextTags: ['home_friendly'],
    locationTags: ['Living Room', 'Gym', 'Home Office'],
    standingOnly: true,
    requiresFloor: false,
    noSweat: false,
    variationKey: 'generated-kettlebell-swing-primer',
    sourceType: 'generated_template',
    reviewStatus: 'approved',
  },
  {
    id: 'generated-jump-rope-interval',
    title: 'Generated Jump Rope Cardio Burst',
    duration: 6,
    intensity: 'medium',
    equipment: ['Jump Rope'],
    instructions: ['Jump rope for 30 seconds at a controlled pace', 'Rest for 20 seconds', 'Repeat 6 rounds', 'Finish with 3 deep breaths'],
    tips: 'Keep elbows tucked and land softly to stay joint-friendly.',
    category: 'Cardio',
    movementTags: ['cardio'],
    bodyRegionTags: ['ankles_calves', 'cardio_endurance'],
    contextTags: ['home_friendly'],
    locationTags: ['Gym', 'Outdoor Space', 'Living Room'],
    standingOnly: true,
    requiresFloor: false,
    noSweat: false,
    variationKey: 'generated-jump-rope-interval',
    sourceType: 'generated_template',
    reviewStatus: 'approved',
  },
  {
