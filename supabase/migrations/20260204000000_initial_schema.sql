-- Initial schema and RLS policies for Kinetic Snacks
...
-- Ensure existing profiles tables get required columns
...
drop policy if exists "space_analyses_select_own" on public.space_analyses;
drop policy if exists "space_analyses_insert_own" on public.space_analyses;
