...
Deno.serve(async (req) => {
  ...
  console.log('allow-ai-plan-generation invoked');
  ...
  const limit = entitlements.monthly_ai_plans;
  ...
  const { error: insertError } = await supabase.from('ai_plan_generations').insert({
